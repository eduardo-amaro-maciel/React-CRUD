    ...
    return (
        <div className="flex w-screen">
            <div className="relative select-none bg-primary">
                <div className="w-80 text-sm h-screen overflow-y-scroll overflow-x-hidden scroll-2 bg-shadow dark:bg-gray flex flex-col">
                    <div className="py-6">
            ...
            <div className="scroll-1 h-screen overflow-y-scroll duration-300 bg-gray-50 dark:bg-black w-full p-12">
